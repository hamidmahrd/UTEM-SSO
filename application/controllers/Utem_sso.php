...
class Utem_sso extends CI_Controller {
    ...
    public function index()
    {
        if(is_cli())
        {
            ...
            $this->cli->out("[green_bold]- show_AD_user/stafid :[white_bold] show AD user and equvalent DB user if exist.[reset]\n")->new_line();
            $this->cli->out("[green_bold]- show_AD_users :[white_bold] show All AD users and equvalent DB user if exist.[reset]\n")->new_line();
